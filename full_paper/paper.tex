...
\paragraph{Key findings.} Two results stand out. First, the quantum estimation advantage over classical MC on the same discretised distribution is consistent: quantum RMSE is 2.2--3.7$\times$ lower than classical across $n=3$--$8$ (Table~\ref{tab:circuit_resources}). This is the genuine algorithmic speedup from Grover amplification, independent of discretisation.
